...
// length of segment inside ellipse x^2 + 4 y^2 < 1
double calculate_segment_length_in_D(double const_coord,
                                     double start_var,
                                     double end_var,
                                     bool vertical)
{
...
// ---------------- MPI decomposition helpers ----------------

// choose Px, Py for Px*Py = size (approximately square)
...
// 2D decomposition of interior indices i = 1..M-1, j = 1..N-1
...
// assemble a_ij, b_ij and B_ij on local subdomain
...
{
    // coefficients on edges (a: vertical, b: horizontal)
...
int main(int argc, char** argv)
{
    ...
    double t_before_finalize = t_after_solver;
